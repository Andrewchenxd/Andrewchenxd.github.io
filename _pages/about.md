...
我是**陈帅**，西安电子科技大学计算机科学与技术硕士（学科评估 A-），现任**小米小爱团队算法工程师**（2026 年 7 月入职，正式员工）。此前于 2025.02–2025.09 在小米小爱算法策略实习，参与小爱同学 GUI 多模态内容理解。
...
| **RL** | GRPO、off-policy、奖励设计、慢思考 CoT |
| **Agent** | GUI Agent、屏幕信息抽取、System Prompt Learning |
| **RSC** | 认知无线电、时频融合、调制分类、辐射源识别 |
...
**校园经历**：东京大学学术合作交流（2023.03–至今）· 数学建模（校赛 / 国赛 / 美赛）· 西电脱口秀俱乐部 · 大学生创新创业训练计划（智能农业 + 高光谱分析）
